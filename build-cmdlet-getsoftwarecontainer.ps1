...
namespace PsTia15
{
  ...
  [Cmdlet(VerbsCommon.Get, "SoftwareContainer")]
  public class GetPlcSoftwareContainerCmdlet : Cmdlet
  {  
    #region Parameters
    ...
    protected SoftwareContainer GetPlcSoftwareContainer () {
        return ((IEngineeringServiceProvider)_device_item).GetService<SoftwareContainer>();
    }
    ...
    {
      WriteObject(GetPlcSoftwareContainer());
    }
